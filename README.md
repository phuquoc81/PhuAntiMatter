...
Minimal PhuAntimatter game scaffold with:

- a browser-based reactor UI in `/frontend`
- a lightweight Node server in `/backend`
- in-memory economy, auth, leaderboard, and payment method handlers
- database and token scaffolding in `/database` and `/tokens`
...
<a href="https://github.com/phuquoc81/PhuAntiMatter/actions/workflows/azure-webapps-node.yml"><img src="https://github.com/phuquoc81/PhuAntiMatter/actions/workflows/azure-webapps-node.yml/badge.svg?branch=copilot%2Fupdate-azure-web-apps-workflow-another-one-again&event=check_run" alt="Azure Web Apps workflow status"></a>
